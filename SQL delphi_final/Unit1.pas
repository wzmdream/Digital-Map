...
begin
     r:=5;
       ...
       DataModule2.ADOQ_tj.SQL.Text:=' select Name,Emap_X,Emap_Y from Unit where Emap_X>-1 and Emap_Y>-1 ' ;
...
begin
 ...
 sumy:=0;
 DataModule2.ADOQ_tj.Close;
 DataModule2.ADOQ_tj.SQL.Text:=' select Name,Emap_X,Emap_Y from Unit where Emap_X>-1 and Emap_Y>-1 and Class='''+ComboBox1.Text+''' and Area='''+ComboBox2.Text+'''' ;
 DataModule2.ADOQ_tj.Open;
